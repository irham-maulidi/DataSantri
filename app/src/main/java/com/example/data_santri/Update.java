...
public class Update extends AppCompatActivity {
    ...
    int id_kelas;
    String nama_kelas, nama_wali, no_wali;
    ...
    private void showData() {
        ...
        no_wali = bundle.getString(Constant.KEY_NO_WALI);

        // Menampilkan ke layar
        edtNamaKelas.setText(nama_kelas);
        edtNamaWali.setText(nama_wali);
        edtNoWali.setText(no_wali);
    }
    ...
    private void getData() {
        ...
        no_wali = edtNoWali.getText().toString();
    }
    ...
    private void saveData() {
        ...
        kelasModel.setNo_wali(no_wali);

        // Melakukan operasi update untuk mengupdate data ke sqlite
        santriDatabase.kelasDao().update(kelasModel);
    }
